...
// Steps
// 1. Calculate the data & time and check if freeze period is over or passed(Even though user can unstake the NFT anytime, they cannot do it before the freeze period is over)
// 2. Unfreeze the frozon NFT
// 3. Remove the delegate approval so user gets full control of the NFT
...
impl<'info> Unstake<'info> {
    pub fn unstake(&mut self) -> Result<()> {
        ...
        require!(
            days >= (self.config.freeze_period as i64),
